import{h as a,A as l}from"./headers.e04ea350.js";const r=document.getElementById("listingsContainer");function i(e){r.innerHTML="",e&&e.forEach(t=>r.innerHTML+=`<a href="/src/html/listing/listing.html?id=${t.id}" class="w-96 h-48 bg-red-500">
          <div>
            <img class="object-scale-down h-32 w-96" src="${t.media}" />
          </div>  
          <p>${t.title}</p>
